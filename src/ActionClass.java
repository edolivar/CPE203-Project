final class ActionClass
{
   ...
   public ActionClass(ActionKind kind, Entity entity, WorldModel world,
   ...
   public static ActionClass createActivityAction(Entity entity, WorldModel world,
                                             ImageStore imageStore)
   {
      return new ActionClass(ActionKind.ACTIVITY, entity, world, imageStore, 0);
   }

   public static ActionClass createAnimationAction(Entity entity, int repeatCount)
   {
      return new ActionClass(ActionKind.ANIMATION, entity, null, null, repeatCount);
   }
}
